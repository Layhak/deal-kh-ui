  ...
  return (
   <div className="flex gap-5">
     <div className="bg-white rounded-lg  flex items-center p-4 w-64 ">
      ...
      <div>
        <h3 className="text-lg font-medium text-black">All Coupons</h3>
    ...
    <div className="bg-white rounded-lg  flex items-center p-4 w-64 ">
      ...
      <div>
        <h3 className="text-lg font-medium text-black">All Boost Ads</h3>
        <p className="text-lg text-black">234</p>
      </div>
    </div>
    <div className="bg-white rounded-lg flex items-center p-4 w-64 ">
      ...
      <div>
        <h3 className="text-lg font-medium text-black">All Discount</h3>
        <p className="text-lg text-black">234</p>
      </div> 
    </div>
    <div className="bg-white rounded-lg flex items-center p-4 w-64 ">
      ...
      <div>
        <h3 className="text-lg font-medium text-black">All Flash Sale</h3>
        <p className="text-lg text-black">234</p>
      </div> 
    </div>
    <div className="bg-white rounded-lg flex items-center p-4 w-64 ">
      ...
      <div>
        <h3 className="text-lg font-medium text-black">All Clearance</h3>
        <p className="text-lg text-black">234</p>
      </div> 
    </div>
   </div>
