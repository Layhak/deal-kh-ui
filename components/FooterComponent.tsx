...
function FooterComponent() {
  return (
    ...
    >
      ...
      <hr />
      <div className="lg:border-foreground-100 p-3 mx-8 flex flex-col justify-center lg:flex-row">
        <Link
          href="#"
...
//     >
//       <div>
//         <div className="mx-auto space-y-4 py-4 lg:space-y-8 lg:py-8">
//           <div className="grid grid-cols-1 text-center md:grid-cols-2 md:gap-20 lg:grid-cols-4 lg:gap-5">
//             {/* Logo */}
//             <div>
...
//         <div className="text-center p-4 mx-8 lg:flex-row lg:space-x-4 lg:border-foreground-100">
//           <div className="w-full h-[1px] bg-slate-600 mb-4"></div>
//           <Link
//             href="#"
//             className="text-foreground-500 text-base transition hover:opacity-75 text-center"
//           >
//             @ 2024. ecommerce website by kon khmer!
//           </Link>
//         </div>  
