  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        ...
        <h1 className="text-orange-500">Deal-KH</h1>
        <button
          ref={trigger}
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <Link
                  href="/dashboard"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium dark:text-white text-black duration-300 ease-in-out hover:bg-orange-500 hover:text-white dark:hover:bg-orange-500 dark:hover:text-white ${pathname.includes("/dashboard") &&
              ...
              <li>
                <Link
                  href="/report"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium dark:text-white text-black duration-300 ease-in-out hover:bg-orange-500 hover:text-white dark:hover:bg-orange-500 dark:hover:text-white ${pathname.includes("/admin/report") && "bg-orange-500 text-white dark:bg-orange-500 dark:text-white"
                    }`}
                >
                  <svg
                    className="fill-current"
