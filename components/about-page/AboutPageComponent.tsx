        ...
        <div className="my-8 flex flex-col items-center md:flex-row-reverse">
          ...
          >
            ...
            <p className="mt-4 text-lg">
              ...
              humble beginnings to becoming a trusted name in e-commerce,
              Deal-Kh has consistently focused on enhancing the shopping
        ...
        <div className="my-8 flex flex-col items-center md:flex-row">
          ...
          >
            ...
            <p className="mt-4 text-lg">
              ...
              offering unparalleled convenience, exceptional customer service,
              and a diverse range of high-quality products.
            </p>
          </div>
          {/* right section image */}
          <div className="p-4 md:w-1/2">
