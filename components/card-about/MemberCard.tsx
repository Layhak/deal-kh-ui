...
export default function MemberCard() {
  ...
  return (
    <div className="my-8 flex flex-wrap justify-center gap-[26.6px] ">
      {mentors.map((item, index) => (
        <div
          key={index}
          className="flex w-72 max-w-sm flex-col items-center overflow-hidden rounded-2xl border-0  border-solid p-8"
        >
          <Image
            isBlurred
            radius={'full'}
          ...
          <div className="px-6 py-4 text-center">
            <div className="mb-2 text-[18px] font-bold">{item.name}</div>
            <div className="mb-2 text-base">{item.role}</div>
          </div>
