...
export default function CardComponent({
  ...
  return (
    <div>
      <Card
        isBlurred
        className="relative mx-4 max-w-full border-none bg-background/60 dark:bg-default-100/50"
        shadow="sm"
      >
        <CardBody>
          <div className="m-8 grid grid-cols-6 items-center justify-center gap-6 gap-y-8 p-8 md:grid-cols-12 md:gap-4">
            ...
            <div className="col-span-6 flex flex-col">
              ...
              <div className="flex items-start justify-between">
                <div className="flex flex-col gap-0">
                  ...
                  <p className="mt-4 text-small text-foreground/80">
              ...
              <Button className="mt-8 w-32 bg-slate-950 text-slate-100">
                Add to Cart
              </Button>
