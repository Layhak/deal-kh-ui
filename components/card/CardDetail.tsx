            ...
            <div className="flex flex-col col-span-6">
              ...
              <div className="flex justify-between items-start">
                <div className="flex flex-col gap-0">
                  ...
                  <p className="text-small text-foreground/80 mt-4">Trending Short for easy wear which provide
                  comfort for you which is really comfortable especially in hot weather.</p>
                </div>
              </div>
