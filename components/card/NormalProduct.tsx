...
// interface NormalProductComponentProps {
//   currentPage: number;
// }

// const NormalProductComponent: React.FC<NormalProductComponentProps> = ({ currentPage }) => {
//   const [data, setData] = useState<{ payload: { list: CartProductType[] } } | null>(null);
...
//                 <div className="flex justify-end gap-[15px]">
//                   <FaRegHeart
//                     className="h-[25px] w-[x  25px] text-[#eb7d52]"
//                     onClick={() =>
//                       dispatch(
//                         addToWishList({
//                           slug: product.slug,
...
// export default NormalProductComponent;
