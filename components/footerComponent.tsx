...
function FooterComponent() {
    return (
        <footer className="dark:bg-black dark:text-white flex flex-col justify-center">
            <div className="max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8 mx-auto">
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-3 justify-center">
                    ...
                    {/* Links */}
                    <div className="flex flex-col items-center lg:flex-row lg:items-start lg:justify-center lg:space-x-16 w-[50vw]">
                        <div className="">
                            <p className="text-gray-900 mb-6 text-center lg:text-left font-bold">Make Money with Us</p>
                            <ul className="space-y-4 text-sm text-center lg:text-left">
                                <li><Link href="#" className="text-gray-700 transition hover:opacity-75">Sell products</Link></li>
                                <li><Link href="#" className="text-gray-700 transition hover:opacity-75">Create shop</Link></li>
                                <li><Link href="#" className="text-gray-700 transition hover:opacity-75">Advertise your products</Link></li>
                                <li><Link href="#" className="text-gray-700 transition hover:opacity-75">Self-Public with Us</Link></li>
                                <li><Link href="#" className="text-gray-700 transition hover:opacity-75">Enjoy your business</Link></li>
                            </ul>
                        </div>
