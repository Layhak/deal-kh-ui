        ...
        <>
            <main className="w-full h-screen flex flex-col justify-center items-center">
                ...
                <div className="flex gap-4">
                    <button className="bg-red-600 py-2 px-6 rounded-md text-white" onClick={() => signOut()}>Sign out</button>
                    <Link href="/"><button className="bg-warning text-white py-2 px-6 rounded-md" >Go Back</button></Link>
                </div>
            </main>
        </>
    );
