  ...
  return (
    <div className="flex flex-wrap justify-center gap-[25px] mt-2 overflow-hidden">
      <div className="lg:w-[820px] md:w-[350px] sm:w-[350px]">
        <Swiper
          className='border border-white dark:border-black rounded-lg lg:h-[418px] md:h-[195px] h-[195px] '
          spaceBetween={50}
          slidesPerView={1}
          autoplay={{
            delay: 2500,
      ...
      <div className="grid grid-cols-1 gap-[25px] lg:w-[385px]">
        <div className="lg:w-[385px] sm:w-[350px] relative">
          <Swiper
            className='border border-white dark:border-black rounded-lg h-[195px]'
            spaceBetween={50}
            slidesPerView={1}
            onSlideChange={() => { }}
